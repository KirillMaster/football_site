...
export const mockReviews: Review[] = [
  {
    id: 1,
    author: 'Елена З.',
    text: 'Были на бесплатном занятии, ребенку очень понравилось и мы записались на постоянку. Отличная задумка — первый уровень, где только показывают и рассказывают, что такое футбол.',
    rating: 5,
    childAge: 7,
  },
  {
    id: 2,
    author: 'Папа Татьяны Н.',
    text: 'Благодарим "Арсенал" за возможность быть частью команды столько лет. Годы тренировок не прошли даром и теперь мы — участники женской команды Футбольной Академии Крыма. Спасибо тренеру и ребятам за полученный опыт!',
    rating: 5,
    childAge: 14,
  },
  {
    id: 3,
    author: 'Любящая мама',
    text: 'Огромная благодарность клубу за возможность тренироваться в таком составе и с такими партнёрами! Сын значительно вырос в собственных навыках дриблинга, скорости и формировании позиционных атак.',
    rating: 5,
    childAge: 11,
  },
];
