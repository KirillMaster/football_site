...
export const mockReviews: Review[] = [
  {
    id: 4,
    author: 'Инна Ромашук',
    text: 'Начать с сухого перечисления плюсов и минусов? Лучше начну с эмоций. Радует! Обучение футболу в «Арсенале» радует моего ребёнка, радует меня, радует болельщиков клуба! Сын с удовольствием ходит на тренировки. Вижу, как прогрессирует в игре, как оттачивает навыки на поле. Будучи игроком 2014 года рождения, привлекается на игры старшего состава. Наш тренер — Игорь Рамизович — воспитывает футболистов, а не винтиков в команде. Ребята играют на разных позициях, во время матчей не хотят уходить с поля во время замен и снова просятся играть, потому что любят то, чем занимаются. У нас классная команда родителей-болельщиков — всегда поддерживаем ребят на матчах. Плюсы: у ФК «Арсенал» есть индивидуальный подход, командный дух и любовь к футболу. Минусы: играют все, даже если ещё вчера была первая тренировка. Хотя нет — это тоже плюс! Ведь все хотят играть в футбол, и у всех есть такая возможность. «Арсенал! Вперёд!»',
    rating: 5,
    childAge: 12,
  },
  {
    ...
    text: 'Давно вместе с Игорем, команда 2011 года ещё со «Спартака». Сейчас ходит уже второй ребёнок, который бежит на тренировку с удовольствием. Новый сайт — огонь, следующий шаг — своя база :)',
    rating: 5,
  },
  {
    id: 1,
